...
struct ArraysQuizView: View {
    @StateObject var quizViewModel = ArrayViewModel() //StateObject - viewModel will change and redraw the view
    ...
    var quizContent: some View { //MAIN CONTENT ON PAGE
        VStack {
            HStack {
                Text("Arrays Quiz") // category name at the top
                    .font(.title2)
                    .fontWeight(.bold)
                    .foregroundColor(Color.red)
                    .padding([.leading, .bottom, .trailing])
    ...
    func colorOnAnswer(at buttonIndex: Int) -> Color{
        ...
        if userTapBtnIndex  == quizViewModel.correctAnswerIndex { //if user choice is equal to correct answer
...
//struct ArraysQuizView_Previews: PreviewProvider {
//    static var previews: some View {
//        ArraysQuizView( ArraysQuizScore: 2)
//    }
//}
