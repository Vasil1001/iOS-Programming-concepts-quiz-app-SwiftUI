    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                ...
                VStack {
                    Text("Declaring Data Types tutorial")
                        .font(.title)
                        .fontWeight(.heavy)
                    ...
                    Text("Swift offers a collection of built-in data types which are string, integer, floating-point numbers, and Booleans.\nPractice data types in the code editor following the instructions")
                        .fontWeight(.regular)
                        .foregroundColor(Color.black)
                    ...
                    HStack {
                        NavigationLink(destination: DeclaringTutorialEditor()) {
                            HStack{
                                Text("Code Editor")
...
struct DeclaringTutorial_Previews: PreviewProvider {
