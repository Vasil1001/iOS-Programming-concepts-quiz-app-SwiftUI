...
struct ArraySumEditor: View {
    
    @State private var source = "\nimport SwiftUI\n\n\n//Create an array with numbers from 1 to 6\n\n\n\n\n//create a function that finds the sum of the array elements"
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                Text("Given an array of numbers 1 to 6, create a function that outputs the sum of all array elements")
...
struct ArraySumEditor_Previews: PreviewProvider {
