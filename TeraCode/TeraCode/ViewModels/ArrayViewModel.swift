...
class ArrayViewModel: ObservableObject { //States that it can change - needed to move to next question
    
    //https://www.hackingwithswift.com/quick-start/Swiftui/how-to-use-observedobject-to-manage-state-from-external-objects
    @Published var quiz = ArrayQuiz() // Allow to Publish/update StateObjects that depend on this
