...
//  move the logic from practiceView HERE.
...
class QuizViewModel: ObservableObject { //States that it can change - needed to move to next question
    
    //https://www.hackingwithswift.com/quick-start/Swiftui/how-to-use-observedobject-to-manage-state-from-external-objects
    @Published var quiz = Quiz() // Allow to Publish/update StateObjects that depend on this
